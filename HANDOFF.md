...
- Canonical `main` = `86acce0819f545cef7b8f2aeb8a5156ce9501bb8`; protected pre-existing `AGENTS.md` remains the only dirty path.
...
- `P101M1T01`, `P101M2T01`, and `P101M2T02` are published at `b9ed77012a14da28c4e9f186e055f154a60a5cc8`; P101M3T01 is published at `ab38e9dcf53c14345ae8086bf53ba6241e52e980`; P102M1T01 is published at `86acce0819f545cef7b8f2aeb8a5156ce9501bb8`; evidence is retained under `/home/pi5/hermes-artifacts/kurabe-execution/`.
- `P101 = DONE` for non-production source/local execution; next READY task: `P102M1T02` full release matrix.
