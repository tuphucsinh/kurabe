      ...
      {isLoading ? (
        <>
          ...
          <div className="grid grid-cols-2 gap-2.5 sm:gap-3 md:flex md:items-center md:gap-4 md:flex-wrap">
            <div className="bg-white rounded-2xl border border-outline-variant shadow-sm px-3 py-2.5 md:px-4 md:py-2.5 flex items-center gap-2">
              <Users size={18} className="text-primary shrink-0" />
              <Skeleton variant="text" className="w-8 h-5" />
              <span className="text-xs sm:text-sm text-slate-500">nhân sự</span>
            </div>
            <div className="bg-white rounded-2xl border border-outline-variant shadow-sm px-3 py-2.5 md:px-4 md:py-2.5 flex items-center gap-2">
              <TrendingUp size={18} className="text-emerald-600 shrink-0" />
              <Skeleton variant="text" className="w-8 h-5" />
              <span className="text-xs sm:text-sm text-slate-500">tiến độ</span>
            </div>
            <div className="bg-white rounded-2xl border border-outline-variant shadow-sm px-3 py-2.5 md:px-4 md:py-2.5 flex items-center gap-2">
              <CheckCircle2 size={18} className="text-green-600 shrink-0" />
              <Skeleton variant="text" className="w-10 h-5" />
              <span className="text-xs sm:text-sm text-slate-500">đã đánh giá</span>
            </div>
            <div className="bg-white rounded-2xl border border-outline-variant shadow-sm px-3 py-2.5 md:px-4 md:py-2.5 flex items-center gap-2">
              <Clock size={18} className="text-amber-600 shrink-0" />
              <Skeleton variant="text" className="w-8 h-5" />
              <span className="text-xs sm:text-sm text-slate-500">chưa xong</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            {/* Team Status */}
            <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col lg:col-span-1">
              <h3 className="text-base sm:text-lg font-semibold text-slate-800 mb-4 sm:mb-6">Trạng thái theo nhóm</h3>
            ...
            <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm border border-slate-100">
              <h3 className="text-sm font-bold text-slate-800 mb-3 sm:mb-4">Phân bổ xếp loại</h3>
        ...
        <div className="bg-white p-6 sm:p-12 rounded-3xl border border-dashed border-outline-variant flex items-center justify-center">
          <EmptyState
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-2.5 sm:gap-3 md:flex md:items-center md:gap-4 md:flex-wrap">
            <div className="bg-white rounded-2xl border border-outline-variant shadow-sm px-3 py-2.5 md:px-4 md:py-2.5 flex items-center gap-2">
              <Users size={18} className="text-primary shrink-0" />
              <span className="text-base sm:text-lg font-black text-slate-900">{data.stats.total}</span>
              <span className="text-xs sm:text-sm text-slate-500">nhân sự</span>
            </div>
            <div className="bg-white rounded-2xl border border-outline-variant shadow-sm px-3 py-2.5 md:px-4 md:py-2.5 flex items-center gap-2">
              <TrendingUp size={18} className="text-emerald-600 shrink-0" />
              <span className="text-base sm:text-lg font-black text-slate-900">{data.stats.percent}%</span>
              <span className="text-xs sm:text-sm text-slate-500">tiến độ</span>
            </div>
            <div className="bg-white rounded-2xl border border-outline-variant shadow-sm px-3 py-2.5 md:px-4 md:py-2.5 flex items-center gap-2">
              <CheckCircle2 size={18} className="text-green-600 shrink-0" />
