        ...
        {data.map((item) => {
          ...
          return (
            <div key={item.grade} className="flex items-center group">
              <div className="w-10 text-xs font-bold text-on-surface">{item.grade}</div>
              <div className="flex-1 flex items-center gap-3">
                <div className="flex-1 h-2.5 bg-surface-container rounded-full overflow-hidden relative">
                  <div 
                ...
                <div className="w-8 text-right text-xs font-semibold text-on-surface">
                  {item.count}
                </div>
                <div className="w-10 text-right text-[11px] text-outline">
                  {percentage}%
                </div>
              </div>
            </div>
