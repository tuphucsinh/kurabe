...
export default function AiSummaryCard({
  ...
  return (
    <div
      ...
      className="bg-gradient-to-br from-indigo-50/80 to-white p-6 rounded-3xl border border-indigo-100 shadow-sm flex flex-col justify-between"
    >
      <div>
        ...
        {isLoadingSummary ? (
          <div className="space-y-3 py-4">
            <div className="h-4 w-3/4 bg-indigo-100/60 animate-pulse rounded" />
            <div className="h-4 w-full bg-indigo-100/60 animate-pulse rounded" />
            <div className="h-4 w-2/3 bg-indigo-100/60 animate-pulse rounded" />
          </div>
        ) : isGenerating ? (
