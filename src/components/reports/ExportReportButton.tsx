...
export default function ExportReportButton({ periodId }: { periodId: string }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-4 py-2 bg-white border border-outline-variant rounded-xl text-sm font-medium hover:bg-surface-container transition-colors disabled:opacity-50"
    >
