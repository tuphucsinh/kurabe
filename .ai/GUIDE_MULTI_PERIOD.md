...
- Lịch sử kỳ `Closed` theo route riêng `/history/[employeeId]` đã implement, verify local, commit tại `f79f94f` và deploy production qua `dpl_Fjj9vWWfq7AtuyFJZ1yPLD24CLbs`; alias `https://lykiv.vercel.app`.
