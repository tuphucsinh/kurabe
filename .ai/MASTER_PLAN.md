...
- **P61T07** Verify + docs: build/lint + browser full flow (NV mới gán SubLeader → round 1 đúng người; backfill đúng) + Reviewer (CONTROLLED — schema/workflow) + MASTER_PLAN/tasks/HANDOFF.
